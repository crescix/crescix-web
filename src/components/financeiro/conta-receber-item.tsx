...
import { ContaReceber, formatBRL, formatDateBR } from "@/lib/data/financeiro";
...
export function ContaReceberItem({ data, onEdit, onDelete, onMarkReceived }: ContaReceberItemProps) {
  ...
  return (
    <TableRow className="border-b border-white/5 hover:bg-white/5 transition-colors">
      ...
      <TableCell className="text-white/70 text-sm">
        {data.cliente ?? <span className="text-white/30">—</span>}
      </TableCell>
