...
export function ModalExclusaoOrcamento({
  isOpen, onOpenChange, onConfirm, orcamento,
          ...
          <div className="mt-6">
            ...
            <div className="bg-white/5 border border-white/10 rounded-xl p-5 space-y-3">
              ...
              <div className="grid grid-cols-[110px_1fr] gap-3">
                ...
                <span className="text-white font-medium">{orcamento.cliente}</span>
              </div>
              <div className="grid grid-cols-[110px_1fr] gap-3">
              ...
              <div className="grid grid-cols-[110px_1fr] gap-3">
                ...
                <span className="text-white/80 text-sm">{orcamento.validade}</span>
              </div>
            </div>
          </div>
        </div>
